...
import { orderService, paymentService, authService, settingsService} from '../services/api';
                    ...
                    <div className="bg-orange-50 p-8 rounded-3xl border border-orange-100 text-center">
                       ...
                       {adminQr ? (
                         <div className="max-w-[200px] mx-auto mb-6 bg-white p-4 rounded-2xl shadow-sm border border-orange-200">
                          <img src={adminQr.startsWith('http') ? adminQr : `https://nammamart-backend.onrender.com${adminQr}`} alt="Scan to Pay" className="w-full h-full object-contain" />
                         </div>
                       ) : (
